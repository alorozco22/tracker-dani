...
const actividades1 = [Actividad('1', 'Congregarme', '0', '1', '#003399', 'white', 'Te dejo el enlace de las sedes y horarios de la i por si los quieres tener a la mano preciosa.', 'nan', 'Horarios y sedes IDMJI', 'https://idmji.org/direcciones/', '.', '#', '.', '#'),Actividad('1', 'Servicio', '0', '2', '#003399', 'white', 'Acuérdate de llenar el formulario corazón.', 'nan', '.', '#', '.', '#', '.', '#')]
const actividades2 = [Actividad('2', 'Pensar modelos de negocio', '0', '1', '#600080', 'white', 'Aquí va un texto descriptivo de lo que puede ser esta actividad. Puedes hacer tal cosa, o tal otra, etc. </br></br>En el link 1 tienes un link cool.', '<iframe  style="width:100%" src="https://www.youtube.com/embed/Nfc4l_jHqLU" title="Being An Introvert &amp; Building An Art Business - My Thoughts and Tips" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>', 'Video para ver', 'https://www.artworkarchive.com/blog/a-breakdown-of-business-models-for-artists-plus-free-business-plan-worksheet', '.', '#', '.', '#'),Actividad('2', 'Otra cosa que hacer', '1', '2', '#600080', 'white', 'Puedes hacer cosas interesantes para contribuir a la parte que tienes que incluir en esta parte.', '<h2>Urgente</h2>', 'Museo del prado', 'https://www.museodelprado.es/en', '.', '#', '.', '#'),Actividad('2', 'Una actividad más', '0', '3', '#600080', 'white', 'Podemos armar cosas que haya que armar y ensamblarlas para que al final queden cosas bien ensambladas. Al final puedes citar una reunión para pedir retroalimentación sobre lo armado.', '<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg/800px-Van_Gogh_-_Starry_Night_-_Google_Art_Project.jpg" alt="Noche estrellada de Van Gogh" />', 'Página de cursos', 'https://domestika.org/', '.', '#', '.', '#')]
const actividades3 = []
const actividades4 = []
const actividades5 = [Actividad('5', 'Pensar modelos de negocio', '0', '1', '#008080', 'white', 'Aquí va un texto descriptivo de lo que puede ser esta actividad. Puedes hacer tal cosa, o tal otra, etc. </br></br>En el link 1 tienes un link cool.', '<iframe  style="width:100%" src="https://www.youtube.com/embed/Nfc4l_jHqLU" title="Being An Introvert &amp; Building An Art Business - My Thoughts and Tips" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>', 'Video para ver', 'https://www.artworkarchive.com/blog/a-breakdown-of-business-models-for-artists-plus-free-business-plan-worksheet', '.', '#', '.', '#'),Actividad('5', 'Otra cosa que hacer', '1', '2', '#008080', 'white', 'Puedes hacer cosas interesantes para contribuir a la parte que tienes que incluir en esta parte.', '<h2>Urgente</h2>', 'Museo del prado', 'https://www.museodelprado.es/en', '.', '#', '.', '#')]
const actividades6 = []
