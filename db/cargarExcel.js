...
const horasMiercoles = [Area(1, "Dios", 3, "#003399"),Area(2, "Proyectos", 2, "#600080"),Area(3, "Aplicaciones", 2, "#008080"),Area(8, "Proyectar estudios", 1, "#660033"),Area(10, "Configuraciones", 1, "#009999")]
const horasJueves = [Area(1, "Dios", 2, "#003399"),Area(4, "Comisión", 4, "#600080"),Area(6, "Fortalecer contactos", 2, "#008080"),Area(10, "Configuraciones", 1, "#009999")]
...
const actividades1 = [Actividad('1', 'Oración y lectura', '0', '1', '#003399', 'white', '¡Corazón! Yo se que has ido muy juiciosa estos días a congregarte. Si quieres hoy leer, orar para adquirir doctrina, puede ser una buena idea! Dedícale un tantito si no vas a la i :3 pero dedícale tiempecito a Dios que cuida tanto a tu chico y te cuida a tí <3', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan'),Actividad('1', 'Congregarme', '1', '2', '#003399', 'white', 'Hola vida, hoy depronto tienes alabanza, igual has ido muy juiciosa todos estos días. Yo se que te gusta descansar un día a la semana.', 'nan', 'Horarios y sedes IDMJI', 'https://idmji.org/direcciones/', 'nan', 'nan', 'nan', 'nan'),Actividad('1', 'Servicio', '1', '3', '#003399', 'white', 'Has prestado muuucho servicio esta semana, estoy muy orgulloso de tí corazón :3', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan')]
...
const actividades3 = []
const actividades4 = [Actividad('4', 'Creación de obra', '0', '1', '#600080', 'white', '¡Amor! De nuevo te propongo que para esta actividad la idea es que puedas crear mucha obra! ¡No pares de pintar y experimentar cosas nuevas! Haz una <b>pausa a tu curso de anatomía</b> y dedícale un poco de tiempo a crear obra.</br></br>Podrías comenzar a experimentar con el iPad en Procreate</br></br>O bien, podrías fijarte en tu MoodboArt para inspiración!</br></br>¡Acuérdate que Botero tenía en su colección privada suficientes obras para llenar un museo!', '<a target="_blank" href="./img/mood.png"><img src="./img/mood.png" alt="Captura de pantalla del grupo MoodboArt en Waa" style="width:100%" /></a></br><a target="_blank" href="./img/botero.jpg"><img src="./img/botero.jpg" alt="Museo Botero" style="width:100%" /></a>', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan'),Actividad('4', 'Reunión estrategia de contenido orientado a ventas', '0', '2', '#600080', 'white', 'Agendar a tu chico (la semana después del 31 de mayo) para que nos vayamos pensando una estrategia de publicación y contenido en Entropía Cromática que sea centrada en ventas. ¡Podemos usar técnicas de funneling para esto! Voy a buscar videos que te puedan dar contexto.', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan')]
...
const actividades6 = [Actividad('6', 'Mapear organizaciones', '0', '1', '#008080', 'white', 'Amor! como ayer dedicaste tiempo a aplicaciones de hoja de vida, la idea es que usa una horita para terminar esa redacción y <b>si alcanzas a dedicarle un ratito</b> así sean 30 minutos a armar una tabla con algunas de las empresas que tienen programas de sostenibilidad que operan en Colombia sería maravilloso! <b>La idea es mapear todas las empresas que haya en Colombia con departamento de sostenibilidad</b>. Si tú me ayudas con eso, yo puedo ayudarte renovando contactos por ese lado 🥰', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan')]
const actividades7 = []
