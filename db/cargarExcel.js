...
const actividades11 = [Actividad('11', 'Ir al gym', '0', '1', '#ff8080', 'white', 'Hoy podrías intentar ir si tienes tiempito. Besitossss.', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan')]
const actividades1 = [Actividad('1', 'Enseñanza', '0', '1', '#003399', 'white', 'Hoy voy a la i en la tarde, vamos juntos guapa.', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan'),Actividad('1', 'Oración y lectura', '0', '1', '#003399', 'white', 'Amor, toma un momento para ver un clip de estudio bíblico y orar hoy. 10 minutos. Tú puedes. Te dejo la página donde están las meditaciones cortitas. Piensa que Dios nos puso juntos en la vida. Te amooo.', '<a target="_blank" href="https://www.idmji.org/meditaciones/"><img src="./img/meditaciones.png" alt="Captura de pantalla IDMJI meditaciones" style="width:100%" /></a>', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan')]
const actividades18 = []
const actividades17 = []
...
const actividades4 = [Actividad('4', 'Libro: provisional', '0', '1', '#600080', 'white', 'Amor, yo se que le estás dedicando mucho al libro por estos días, pero no deberías descuidar tu creación de obra. Hoy te propondría que tomes un break del libro y dediques estas horas a crear obra.', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan'),Actividad('4', 'Creación de obra', '0', '1', '#600080', 'white', '¡Piensa en qué proyecto podrías comenzar y dale de una! No paremos la produccion de obra preciosa. Así sea poquito tiempo.', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan', 'nan')]
